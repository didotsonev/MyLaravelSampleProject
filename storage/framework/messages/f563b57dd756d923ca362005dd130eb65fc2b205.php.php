                        ...
                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="email-body_cell">
                                    ...
                                    <!-- Intro -->
                                    <p>
                                        <?php echo e(_i("Your company has been added to our application.")); ?>
                                    ...
                                    <!-- Salutation -->
                                    <p>
                                        <?php echo e(_i('Regards')); ?>,<br><?php echo e(config('app.name')); ?>
                            ...
                            <tr>
                                <td class="fontFamily email-footer_cell">
                                    <p class="">
                                        ...
                                        <a class="anchor" href="<?php echo e(url('/')); ?>" style="color: #3869D4;" target="_blank"><?php echo e(config('app.name')); ?></a>.
                                        <?php echo e(_i('All rights reserved')); ?>.
                                    </p>
                                </td>
                            </tr>
                        </table>
